...
def hello():
    ...
    return render_template('index.html', sleepGraphLabels=timeLabels, values=condensedNightData, timeWeekLabels=weekLabels, averageTime=avgTime, timeGraphData=thisWeekTime, tipsArr=tips)
